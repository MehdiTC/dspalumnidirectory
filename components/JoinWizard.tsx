    ...
    return (
      <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm px-2">
        <div className="bg-white rounded-xl p-8 shadow-lg max-w-md w-full text-center">
          <h2 className="text-2xl font-bold text-[#012169] mb-4">Authentication Required</h2>
          <p className="text-gray-600 mb-6">Please sign in to join the directory.</p>
          <button
            onClick={onClose}
            className="px-6 py-2 bg-[#012169] text-white rounded-lg font-semibold hover:bg-blue-800 transition"
          >
            Close
          </button>
        </div>
            ...
            <motion.div key="basic" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}>
              ...
              <div className="space-y-5">
                ...
                <div>
                  ...
                  <input name="location" value={form.location} onChange={handleChange} placeholder="City, Country" className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#012169] focus:border-[#012169] transition" required />
                </div>
              </div>
